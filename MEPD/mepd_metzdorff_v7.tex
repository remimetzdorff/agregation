...
\usepackage{lmodern} % ensures vector font
\usepackage[bottom]{footmisc} % footnote at the end of a page
...
Stage au LKB avec Pierre Cladé (4 mois) sur le développement de collimateurs compacts pour les faisceaux d'un piège magnéto-optique à atomes de rubidium d'une expérience de métrologie. \\
2012--2013 &
...
Les détecteurs d'ondes gravitationnelles sont des interféromètres de Michelson géants dont les bras sont des cavités Fabry-Perot pour augmenter l'effet d'un petit déplacement : la longueur des bras de Virgo est de \unit{3}{\kilo\meter} avec des cavités de finesse 450.
...
Prédite dès les années 80, c'est l'action en retour de la mesure qui a contribué à fonder l'optomécanique, le domaine de recherche sur l'interaction entre un rayonnement électromagnétique et un mouvement mécanique.
...
\nopagebreak[4]Nous détaillerons ensuite l'utilisation du couplage optomécanique pour le refroidissement de l'oscillateur en cavité.
...
\item un micro-disque en silicium obtenu en collaboration avec l'UniFI (Italie) d'environ $\unit{200}{\micro\meter}$ de diamètre, sur lequel est déposé un miroir de haute réflectivité.
...
Sa conception est soumise à de nombreuses contraintes liées à son utilisation dans un cryostat à dilution et à la nécessité de l'asservir en longueur pour la maintenir résonnante avec le laser.
...
C'est une méthode d'enseignement très vivante que je mettrai en œuvre : l'exploitation d'expériences, y compris durant les cours, me paraît indispensable pour ancrer le discours dans une actualité scientifique ou une réalité quotidienne.

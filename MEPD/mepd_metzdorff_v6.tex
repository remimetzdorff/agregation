...
Cette masse est choisie proche de la masse de Planck ($m_\mathrm{P}=\unit{22}{\micro\gram}$) au dessus de laquelle les effets de décohérence liés à la gravité deviennent significatifs, marquant ainsi la frontière entre les \og mondes \fg{} quantiques et classiques. 
...
\end{equation}
L'intégrale du spectre correspond à la variance $\Delta x^2$ qui est donc fonction directe du rapport $T/m_\mathrm{eff}$.

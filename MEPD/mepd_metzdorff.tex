...
Il en résulte une modulation de la pression de radiation exercée sur les miroirs qui peut en retour modifier la longueur de la cavité : c'est le couplage optomécanique qui peut être exploiter pour le refroidissement d'un mode mécanique de l'oscillateur mécanique.
